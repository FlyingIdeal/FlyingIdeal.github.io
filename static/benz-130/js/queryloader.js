...
function e(t, n, i) {
            ...
            findImageInElement: function(e) {
                ...
                if (!this.hasGradient(t.url)) {
                    ...
                    for (var n = t.url.split(", "), i = 0; i < n.length; i++) if (this.validUrl(n[i]) && this.urlIsNew(n[i])) {
                        var r = ""; (this.isIE() || this.isOpera()) && (r = "?rand=" + Math.random()),
    ...
    4 : [function(e, t, n) {
        ...
        r = {
            create: function() {
                ...
                this.element.innerHTML = '<div id="query_loadImg"></div>',
            ...
            setStyling: function() {
                ...
                //this.element.style.top = "50%",图片相对顶端的位置
    ...
    5 : [function(e, t, n) {
        ...
        r = {
            ...
            applyStyling: function() {
                ...
                //this.element.style.marginTop = "-" + (59 + this.barHeight) + "px",//百分比的位置
                this.element.style.marginTop = "120px",
    ...
    10 : [function(e, t, n) {
        ...
        t.exports = function(e, t) {
            ...
            if (n.element = e, n.options = {},
            n.done = !1, n.maxTimeout = null, n.overlay = null, n.preloader = null, null !== e) {
                var i = function() {};
                n.init(t, {
                    onComplete: i,
                    onProgress: i,
    ...
    11 : [function(e, t, n) {
        e("./Polyfills");
        var i = e("./QueryLoader"),
        r = e("./QueryLoader/TempOverlay"); (window.jQuery || window.Zepto) && !
        function(e) {
            "use strict";
