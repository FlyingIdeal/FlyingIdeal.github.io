...
function switchsound()
{
    ...
    if(au.paused)
    {
        bplay = 1;
        au.play();
        ai.src = "http://special.mercedes-benz.com.cn/S-Class-sustaining-1/mobile/images/music_note_big.png";
...
function create_music()
{
    ...
    bg_htm = "<img id='sound_image' style='width:45px; height:45px' src='http://special.mercedes-benz.com.cn/S-Class-sustaining-1/mobile/images/music_note_big.png'>";
...
function popup_note()
{
    ...
    note.style.cssText = "visibility:visible;position:absolute;background-image:url('http://special.mercedes-benz.com.cn/S-Class-sustaining-1/mobile/images/music_note_small.png');width:15px;height:25px";
